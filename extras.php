...
<div class="container">
    ...
    <div id="bobbycar-stl">
        ...
        <a href="./extras/bobbycar.stl" draggable="false" ondragstart="return false;">
            <img class="img-fluid" src="./extras/bobbycar.jpg" style="
        max-width: 512px; 
        width: 100%; 
        border: 2px;
        border-style: ridge;
    ...
    <div id="logo-stl">
        ...
        <a href="./extras/pfostendynamics.stl" draggable="false" ondragstart="return false;">
            <img class="img-fluid" src="./extras/pfostendynamics.jpg" style="
        max-width: 512px; 
        width: 100%; 
        border: 2px;
        border-style: ridge;
    ...
    <div id="kartoffelfahrzeug">
        ...
        <img class="img-fluid" src="./extras/kartoffel.jpg" style="
        max-width: 512px; 
        width: 100%; 
        border: 2px;
        border-style: ridge;
